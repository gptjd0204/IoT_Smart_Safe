...
public class ShockLogDeviceHandler implements RequestHandler<Event, String> {

    private DynamoDB dynamoDb;
    private String DYNAMODB_TABLE_NAME = "ShockLogging";

    
    // DynamoDB에 ShockLogging 테이블에 있는 로그 내용 조회 RestAPI
    @Override
    public String handleRequest(Event input, Context context) {
        ...
        // 사용자가 지정한 조회시작시간, 조회종료시간을 바탕으로 로그 내용 조회
